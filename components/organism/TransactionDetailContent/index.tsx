          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="purchase pt-30">
                ...
                <Row label='Price' value={`Rp ${jsPriceFormat(42280500)}`} />
                <Row label='Tax (10%)' value={`Rp ${jsPriceFormat(4228000)}`} />
                <Row label='Total' value={`Rp ${jsPriceFormat(55000600)}`} additionalClass='color-palette-4'/>
              </div>
